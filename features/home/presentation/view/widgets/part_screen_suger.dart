  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => SugarCheckCubit()..getsugarlevel(formattedDate)),
      ],
              ...
              children: [
                Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        Textfieldnumber(widget.text2, widget.text3, sugarlevel),
                ...
                GestureDetector(
                  onTap: () async {
                    if (valid.currentState!.validate()) {
                      BlocProvider.of<SugarCubit>(context).sugar(sugarlevel.text, meal!);
                      DateTime currentDate = DateTime.now();
